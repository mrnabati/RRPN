function boxes = selective_search_boxes(im, fast_mode=false)

% Obtained from R-CNN (https://github.com/rbgirshick/rcnn/tree/master/selective_search)
